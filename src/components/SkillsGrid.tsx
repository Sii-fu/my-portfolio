...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaGit, FaLinux, FaJava, FaGithub, FaPython, FaDocker, FaFigma } from 'react-icons/fa';
import { SiTailwindcss, SiNextdotjs, SiTypescript, SiFramer, SiExpress, SiMongodb, SiMysql, SiPostgresql, SiFirebase, SiPostman, SiSupabase, SiFlutter, SiDart, SiVercel, SiC, SiGoogle, SiHuggingface, SiOpencv, SiLangchain } from 'react-icons/si';
